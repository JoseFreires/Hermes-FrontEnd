...
export default function Encomendas() {
  ...
  const data = [
    ...
    },
    {
      ...
      email: "ze@email.com",
      descricao:
        "Pacote extremamente suspeito com um cheiro estranho e formato duvidoso embalado em um papel de presente com desenhos de caveiras e sangue (isso foi sugestão do copilot e n é meme)",
